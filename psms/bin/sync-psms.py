#!/usr/bin/env python
#
# This file is part of encyc-psms
#
...
script user to generate keys and set up passwordless SSH.
    ...
    encyc $ ssh-keygen -t rsa -b 4096 -C "encyc@psms"
...
Add this to `/etc/crontab`:
    ...
    # encyc-psms: get primary-source images from dango
    SHELL=/bin/bash
    */60 *  * * *   encyc   /usr/local/src/env/psms/bin/python /usr/local/src/encyc-psms/psms/bin/sync-psms.py
...
def exec_scp_cmds(cmds, dryrun=False):
    """Execute scp commands generated by make_scp_cmds.
    
    TODO Fix this horribly unsafe function!
    
    @param cmds: list of commands for subprocess
